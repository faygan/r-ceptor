...
namespace Service.PersonelService.Controllers
{
    ...
    public class AuthenticationController : ApiController
    {
        ...
        [HttpGet]
        [Route("auth")]
        public IHttpActionResult Authentication([FromUri]AuthContext context, string scope)
        {
            return Ok(new
            {
                Scope = scope,
        ...
        [HttpGet]
        [Route("verify")]
        public IHttpActionResult VerifyAuthentication([FromUri] AuthContext context)
        {
            return Ok(new
            {
                Scope = "N/A",
